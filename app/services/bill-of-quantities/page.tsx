    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Accurate cost estimation and material quantification for your
                construction projects. Our detailed BOQ services ensure budget
                control and project transparency from start to finish.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive quantity surveying services that provide accurate
              cost control and material planning for your construction projects.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Precise measurement and quantification of all construction materials and labor.",
                features: [
                  "Material Takeoffs",
                  "Labor Calculations",
              ...
              },
              {
                ...
                description:
                  "Accurate pricing based on current market rates and local supplier networks.",
                features: [
              ...
              },
              {
                ...
                description:
                  "Comprehensive budget planning with contingencies and cash flow projections.",
                features: [
                  "Budget Breakdown",
                  "Payment Schedules",
                  "Risk Assessment",
      ...
      <section className="bg-slate-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-serif font-bold text-gray-900 mb-4">
              Why Choose Our BOQ Services?
            </h2>
            <p className="text-lg text-gray-600">
              Professional quantity surveying that saves time and money
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "Prevent cost overruns with precise material and labor calculations",
                },
                {
                  title: "Transparent Pricing",
                  description:
                    "Detailed breakdown of all costs for complete project transparency",
                },
                {
                  title: "Local Expertise",
                  description:
                    "Deep knowledge of Ghana's construction market and material costs",
                },
                {
                  title: "Time Savings",
                  description:
                    "Professional BOQ preparation saves weeks of planning time",
                },
              ].map((benefit, index) => (
      ...
      <section className="bg-terracotta py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-serif font-bold text-white mb-4">
            Need Accurate Cost Estimation?
          </h2>
          <p className="text-xl text-terracotta-100 mb-8">
            Get a detailed Bill of Quantities for your project and take control
