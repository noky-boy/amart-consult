...
import { ArrowLeft, CheckCircle, Users, Clock, Award } from "@/components/ui/icons"
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-50 to-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl lg:text-5xl font-serif font-bold text-gray-900 mb-6">Architectural Designs</h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Transform your vision into stunning architectural masterpieces. Our comprehensive design services blend
                creativity with functionality to create spaces that inspire and endure.
              </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-serif font-bold text-gray-900 mb-4">Our Design Services</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              From concept to completion, we provide comprehensive architectural design solutions tailored to your
            ...
            {[
              {
                ...
                description: "Custom homes, renovations, and residential complexes designed for modern living.",
                features: ["Floor Plans", "3D Visualizations", "Interior Layouts", "Landscape Integration"],
              },
              {
                title: "Commercial Design",
                description: "Office buildings, retail spaces, and commercial complexes that drive business success.",
                features: ["Space Planning", "Brand Integration", "Accessibility Compliance", "Energy Efficiency"],
              },
              {
                title: "Mixed-Use Development",
                description: "Innovative designs that combine residential, commercial, and recreational spaces.",
                features: ["Urban Planning", "Community Spaces", "Sustainable Design", "Traffic Flow"],
              },
            ].map((service, index) => (
              <div
                key={index}
      ...
      <section className="bg-slate-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-serif font-bold text-gray-900 mb-4">Our Design Process</h2>
            <p className="text-lg text-gray-600">A systematic approach to bringing your vision to life</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Consultation", description: "Understanding your vision, requirements, and budget" },
              {
                ...
                description: "Initial sketches and design concepts for your review",
              },
              {
                step: "03",
                title: "Development",
                description: "Detailed drawings, 3D models, and technical specifications",
              },
              { step: "04", title: "Finalization", description: "Final plans ready for construction and permits" },
            ].map((phase, index) => (
      ...
      <section className="bg-terracotta py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-serif font-bold text-white mb-4">Ready to Start Your Design Journey?</h2>
