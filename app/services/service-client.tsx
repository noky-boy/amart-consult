...
interface ServicePageProps {
  ...
  service?: any; // Add service as optional prop for client component
}

export default function ServicePage({ params, service }: ServicePageProps) {
  ...
  // If no service prop provided, this would need to be handled by parent
  if (!service) {
    notFound();
  }
