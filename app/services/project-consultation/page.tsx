          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Expert guidance and strategic advice for your construction and
                architectural projects. Get professional insights that save
                time, money, and ensure project success.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Professional advice and guidance across all aspects of
            ...
            {[
              {
                ...
                description:
                  "Assess project viability, budget requirements, and potential challenges.",
                features: [
                  "Site Analysis",
                  "Budget Assessment",
                  "Timeline Planning",
              ...
              },
              {
                title: "Design Review",
                description:
                  "Expert review of architectural plans and design proposals.",
                features: [
                  "Plan Analysis",
                  "Code Compliance",
                  "Design Optimization",
              ...
              },
              {
                ...
                description:
                  "Ongoing support and advice throughout the construction process.",
                features: [
                  "Progress Reviews",
                  "Quality Checks",
                  "Problem Solving",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Our structured approach to providing valuable insights
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                step: "02",
                title: "Analysis",
                description: "Thorough review of plans, site, and requirements",
              },
              {
                step: "03",
                title: "Recommendations",
                description: "Detailed advice and strategic recommendations",
              },
              {
                step: "04",
                title: "Follow-up",
              ...
              {[
                {
                  ...
                  description:
                    "Deep expertise in Ghana's construction and architectural landscape",
                },
                {
                  title: "Cost Savings",
                  description:
                    "Avoid expensive mistakes with professional guidance upfront",
                },
                {
                  title: "Local Knowledge",
                  description:
                    "Understanding of local regulations, materials, and best practices",
                },
                {
                  title: "Objective Advice",
                  description:
                    "Unbiased recommendations focused on your project's success",
                },
              ].map((benefit, index) => (
      ...
      <section className="bg-terracotta py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-serif font-bold text-white mb-4">
            Need Expert Project Advice?
          </h2>
          <p className="text-xl text-terracotta-100 mb-8">
            Get professional consultation that can save you time, money, and
