...
export default async function ServicePage({ params }: ServicePageProps) {
  ...
  const serviceSchema = {
    ...
    availableChannel: {
      "@type": "ServiceChannel",
      serviceUrl: `https://amart-consult.vercel.app/services/${params.slug}`,
    },
    hasOfferCatalog: service.features
      ? {
          "@type": "OfferCatalog",
          name: service.title,
          itemListElement: service.features.map(
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Home",
        item: "https://amart-consult.vercel.app",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Services",
        item: "https://amart-consult.vercel.app/services",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: service.title,
        item: `https://amart-consult.vercel.app/services/${params.slug}`,
      },
    ],
  };
  ...
  return (
    <>
      {/* Add these structured data scripts */}
      <script
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-16 bg-gradient-to-br from-indigo-50 to-terracotta-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <Link
                href="/services"
                className="inline-flex items-center text-indigo-deep hover:text-terracotta mb-6"
              >
                <ArrowLeft className="w-4 h-4 mr-2" />
                Back to Services
              </Link>

              <h1 className="text-4xl md:text-6xl font-serif font-bold text-indigo-deep mb-6">
                {service.title}
              </h1>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Button
                  size="lg"
                  className="bg-terracotta hover:bg-terracotta-hover text-white px-8 py-3"
                >
        ...
        {service.process && service.process.length > 0 && (
          <section className="py-16">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl font-serif font-bold text-indigo-deep mb-12 text-center">
                  Our Process
                </h2>
                    ...
                    <Card key={index} className="border-0 shadow-lg">
                      <CardHeader>
                        <div className="flex items-center space-x-4">
                          ...
                          <CardTitle className="text-xl text-indigo-deep">
                            {step.title}
                          </CardTitle>
                        </div>
                      </CardHeader>
